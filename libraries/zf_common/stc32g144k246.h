...
/////////////////////////////////////////////////
//
// 如下特殊功能寄存器位于扩展 XRAM 区域
// 访问这些寄存器前，需要先将 EAXFR 设置为 1，才可正常读写
//    EAXFR = 1;
//鎴栬€?
//    P_SW2 |= 0x80;
///////////////////////////////////////////////////
...
#define EAXSFR()        EAXFR = 1       /* MOVX A,@DPTR/MOVX @DPTR,A 指令的操作对象为扩展 SFR(XSFR) */
#define EAXRAM()        EAXFR = 0       /* MOVX A,@DPTR/MOVX @DPTR,A 指令的操作对象为扩展 RAM(XRAM) */
